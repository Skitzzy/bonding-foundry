...
/**
    @title ITSRYIndexWrapper
    @notice This interface is used to wrap cross-chain oracles to feed an index without needing IsTSRY, 
    while also being able to use sTSRY on mainnet.
 */
interface ITSRYIndexWrapper {
...
/**
    @title YieldSplitter
    @notice Abstract contract that allows users to create deposits for their gTSRY and have
            ...
            emergency controls, sending and recieving gTSRY is up to the implementation of
            this abstract contract to handle.
 */
abstract contract YieldSplitter is OlympusAccessControlledV2, IYieldSplitter {
    using SafeERC20 for IERC20;

    ITSRYIndexWrapper public immutable indexWrapper;

    struct DepositInfo {
        uint256 id;
        address depositor;
        uint256 principalAmount; // Total amount of sTSRY deposited as principal, 9 decimals.
        uint256 agnosticAmount; // Total amount deposited priced in gTSRY. 18 decimals.
    }
    ...
    /**
        @notice Constructor
        @param indexWrapper_ Address of contract that will return the sTSRY to gTSRY index. 
                             On mainnet this will be sTSRY but on other chains can be an oracle wrapper.
    */
    constructor(address indexWrapper_, address authority_) OlympusAccessControlledV2(IOlympusAuthority(authority_)) {
        indexWrapper = ITSRYIndexWrapper(indexWrapper_);
    }

    /**
        @notice Create a deposit.
        @param depositor_ Address of depositor
        @param amount_ Amount in gTSRY. 18 decimals.
    */
    ...
    /**
        @notice Add more gTSRY to the depositor's principal deposit.
        @param id_ Id of the deposit.
        @param amount_ Amount of gTSRY to add. 18 decimals.
    */
    ...
    */
    ...
    /**
        ...
        @param id_ Id of the deposit.
        @return amountWithdrawn : amount of gTSRY withdrawn. 18 decimals.
    */
    ...
    /**
        @notice Redeem excess yield from your deposit in sTSRY.
        @param id_ Id of the deposit.
        @return amountRedeemed : amount of yield redeemed in gTSRY. 18 decimals.
    */
    ...
    /**
        ...
        @param id_ Id of the deposit.
        @dev Internally for accounting reasons principal amount is stored in 9 decimal TSRY terms. 
        Since most implementations will work will gTSRY, principal here is returned externally in 18 decimal gTSRY terms.
        @return principal : amount of principal that was deleted. in gTSRY. 18 decimals.
        @return agnosticAmount : total amount of gTSRY deleted. Principal + Yield. 18 decimals.
    */
    ...
    */
    ...
    /**
        ...
        @return uint256 amount of yield in gTSRY. 18 decimals.
     */
    ...
    /**
        @notice Convert flat sTSRY value to agnostic gTSRY value at current index
        @dev Agnostic value earns rebases. Agnostic value is amount / rebase_index.
             1e18 is because sTSRY has 9 decimals, gTSRY has 18 and index has 9.
     */
    ...
    /**
        @notice Convert agnostic gTSRY value at current index to flat sTSRY value
        @dev Agnostic value earns rebases. sTSRY amount is gTSRYamount * rebase_index.
             1e18 is because sTSRY has 9 decimals, gTSRY has 18 and index has 9.
     */
