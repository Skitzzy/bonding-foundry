...
abstract contract FrontEndRewarder is OlympusAccessControlled {
    ...
    IERC20 internal immutable TSRY; // reward token

    constructor(IOlympusAuthority _authority, IERC20 _TSRY) OlympusAccessControlled(_authority) {
        TSRY = _TSRY;
    }
    ...
    function getReward() external {
        ...
        TSRY.transfer(msg.sender, reward);
    }
