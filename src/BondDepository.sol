...
contract OlympusBondDepositoryV2 is IBondDepository, NoteKeeper {
    ...
    constructor(
        ...
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _TSRY, _gTSRY, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _TSRY.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of gTSRY due
        ...
        )
    {
         ...
         * price = quote tokens : TSRY (i.e. 42069 DAI : TSRY)
         *
         * 1e18 = TSRY decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of TSRY that the market can sell
        ...
        // purchased, and how much TSRY has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // TSRY decimals (9) + price decimals (9)
             ...
             * is 10,000 TSRY. max payout would be 1,000 TSRY (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in TSRY or quote), initial price / TSRY (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         *
         * 1e18 = TSRY decimals (9) + initial price decimals (9)
         */
        uint64 targetDebt = uint64(_booleans[0] ? ((_market[0] * 1e18) / _market[1]) / 10**decimals : _market[0]);

        /*
         * max payout is the amount of capacity that should be utilized in a deposit
         * interval. for example, if capacity is 1,000 TSRY, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 TSRY.
         */
        ...
        emit CreateMarket(id_, address(TSRY), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in TSRY decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of TSRY to be paid in TSRY decimals
     *
     * @dev 1e18 = TSRY decimals (9) + market price decimals (9)
     */
     ...
     * @param _id          ID of market
     * @return             current debt for market in TSRY decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in TSRY decimals
     */
